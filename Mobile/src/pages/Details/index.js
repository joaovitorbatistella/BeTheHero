...
export default function Details(){
    ...
    const message = `Olá "${incident.name}", estou entrando em contato pois gostaria ajudar no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', 
        currency: 'BRL'
   ...
   return(
    <View style={styles.container}>
        ...
        <View stule={styles.contactBox}>
            <Text style={styles.heroesTitle}>Salve o dia!</Text>
            <Text style={styles.heroesTitle}>Seja o heroi desse caso.</Text>
